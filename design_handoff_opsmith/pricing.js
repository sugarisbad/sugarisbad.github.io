// Shared opsmith price list. Base prices in RUB; EN pages convert to USD at the CBR daily rate.
export const CBR_RATE_URL = 'https://www.cbr-xml-daily.ru/daily_json.js';
export const FALLBACK_USD_RATE = 92; // used when the CBR API is unreachable
