...
export const en: Dict = {
  ...
  servicesPage: {
    title: 'DevOps Services & Pricing: Server Setup from $95, CI/CD, Monitoring — opsmith',
    desc: 'DevOps services and pricing: Linux/VPS server setup from $95, CI/CD pipeline setup, server monitoring (Grafana, Telegram alerts), self-hosted LLM with Ollama from $275, Telegram bot development. Fixed written quotes.',
    ...
    priceNote1: '<b>Managed administration</b> — from $140/mo: monitoring, updates, incident response, small fixes. &nbsp;·&nbsp; One-off consultation — $55/hour.',
    listEyebrow: '// full price list',
    listH2: 'Typical tasks',
    orderBtn: 'Order',
    priceNote2: 'Hourly rate — <b>$55/hour</b>. Combining several services is cheaper than ordering them separately: we merge the work and never charge twice for the same thing. Work starts after prepayment — 50/50 on small tasks.',
  ...
  workPage: {
    ...
    desc: 'How much DevOps work costs and how it goes at opsmith: $55/hour, a written fixed quote before start, prepayment-based workflow, 30 days of free support after delivery. Frequently asked questions.',
  ...
  bundles: {
    eyebrow: '// bundles',
    h2: 'Bundles that save money',
    lead: 'Services that are most often ordered together. The work overlaps, so a bundle is honestly cheaper than the same items ordered separately.',
    items: [
      {
        slug: 'bundle-server',
        title: 'Server under watch',
        desc: 'Turnkey VPS setup + monitoring with Telegram alerts: deployed — and you immediately see what’s happening to your server.',
        price: 'from $270',
        oldPrice: 'from $300',
        save: 'save $30',
      ...
      {
        slug: 'bundle-deploy',
        title: 'Hands-free deployment',
        desc: 'Dockerization + compose stack + CI/CD: from “works on my machine” to auto-deploy on push to main.',
        price: 'from $485',
        oldPrice: 'from $550',
        save: 'save $65',
        cta: 'Order the bundle',
      },
      {
        ...
        desc: 'Self-hosted AI (Ollama) + an AI agent or Telegram bot on top of it — all the intelligence on your hardware.',
        price: 'from $740',
        oldPrice: 'from $825',
        save: 'save $85',
        cta: 'Order the bundle',
  ...
  compare: {
    ...
    rows: [
      ...
      ['Entry budget', 'from $95 per task', 'from $1,200 + management', 'from $1,700/mo + taxes'],
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'For 30 days after delivery, fixes to the delivered work are free. After that — either one-off requests at the hourly rate, or managed administration from $140/mo where we watch the system ourselves.',
    },
    {
  ...
  priceGroups: [
    {
      ...
      icon: '🛡️',
      items: [
        { slug: 'vps-setup', name: 'Turnkey VPS setup', desc: 'nginx + SSL, firewall, SSH hardening, systemd autostart, health checks, documentation', price: 'from $95', time: '1–2 days' },
        { slug: 'audit', name: 'Audit of an existing server', desc: 'Security and failure-point review, a written report with a fix plan and prices', price: '$55', time: '1–2 hours' },
        { slug: 'nginx-ssl', name: 'nginx: domains, SSL, reverse proxy', desc: 'Virtual hosts, Let’s Encrypt with auto-renewal, redirects, gzip/brotli, caching', price: 'from $70', time: '1 day' },
        { slug: 'migration', name: 'Migration to a new server', desc: 'Moving applications, databases and domains with zero downtime, verification and a rollback plan', price: 'from $170', time: '1–3 days' },
        { slug: 'backup', name: 'Backups', desc: 'Automatic database and file backups to external storage, restore verification', price: 'from $110', time: '1 day' },
      ],
    },
    {
      ...
      icon: '🐳',
      items: [
        { slug: 'dockerize', name: 'Dockerizing an application', desc: 'Dockerfile with multi-stage build, image size optimization, .dockerignore, documentation', price: 'from $140', time: '1–2 days' },
        { slug: 'compose', name: 'docker-compose stack', desc: 'App + database + cache + queue in one compose: networks, volumes, health checks, limits', price: 'from $205', time: '2–3 days' },
        { slug: 'cicd', name: 'CI/CD pipeline', desc: 'GitLab CI / GitHub Actions: tests → build → deploy on push, secrets, staging, rollbacks', price: 'from $205', time: '2–4 days' },
        { slug: 'mass-deploy', name: 'Mass deployment', desc: 'Scripts to roll out an identical configuration to a fleet of servers: cloud-init, idempotent steps', price: 'from $350', time: 'from 1 week' },
      ],
    },
    {
      ...
      icon: '📈',
      items: [
        { slug: 'monitoring', name: 'Monitoring + Telegram alerts', desc: 'Server and application metrics, health checks, instant incident notifications', price: 'from $205', time: '2–4 days' },
        { slug: 'balancer', name: 'Load balancing', desc: 'HAProxy / nginx upstream: traffic distribution, health checks, graceful switchover', price: 'from $250', time: '3–5 days' },
        { slug: 'failover', name: 'Automatic failover', desc: 'A standby environment + automatic switchover when the primary fails, failure scenario testing', price: 'from $415', time: 'from 1 week' },
      ],
    },
    {
      ...
      icon: '🧠',
      items: [
        { slug: 'ollama', name: 'Self-hosted AI (Ollama)', desc: 'Model selection for your hardware, quantization, HTTP API for your services, replacing paid APIs', price: 'from $275', time: '2–4 days' },
        { slug: 'tg-bot', name: 'AI agent / Telegram bot', desc: 'A bot with LLM parsing of free-form commands, notifications, integration with your API, deployment', price: 'from $550', time: '1–2 weeks' },
        { slug: 'turnkey', name: 'Turnkey system', desc: 'Architecture, high availability, CI/CD, cloud API integrations, tests and documentation', price: 'from $2,200', time: 'from 3 weeks' },
      ],
    },
    {
      title: 'Support',
      icon: '🤝',
      items: [
        { slug: 'subscription', name: 'Managed administration', desc: 'Monitoring, updates, incident response, small fixes — your server under supervision', price: 'from $140/mo', time: 'ongoing' },
        { slug: 'consult', name: 'One-off consultation', desc: 'A call: review of your infrastructure, answers to questions, an action plan', price: '$55/hour', time: 'by appointment' },
        { slug: 'incident', name: 'Emergency incident response', desc: 'Your server is down right now — we connect, diagnose, bring it back up and write a post-mortem', price: 'from $85', time: 'today' },
      ],
    },
  ],
};
